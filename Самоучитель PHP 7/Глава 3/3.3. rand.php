<!--Задание 3.3. Найдите в документации функцию генерации случайных чисел mt_rand(), ознакомьтесь с ее возможностями. Создайте скрипт, который генерировал бы случайное число от 0 до 10000 !-->
<!DOCTYPE html>
<html>  
    <head>
    ...
    <body><center>
        ...
        <form method="POST">
            ...
            поля, если оно не пустое или фиксированное начальное значение от 0 до 10000, также устанавливается минимальное - min - значение и максимальное - max - с помощью вставки php скрипта, который возвращает максимальное число для генератора mt_rand, плюс устанавливается размер поля в 50 пикселей !-->
